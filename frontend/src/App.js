    ...
    <div className="app">
      ...
      {ipAddress ? <div className="memories">
        ...
        <ul>
          ...
          <li className="memory"> i am left to believe that the only way she will ever accept me is if I let her be. but be warned, her constant push and pull, her evasive looks and her rivers of rakija might be just enough to lure you in. </li>
